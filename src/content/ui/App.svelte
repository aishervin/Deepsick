<script>
  ...
  const studioLauncherIcon = "https://raw.githubusercontent.com/aishervin/Deepsick/main/android/app/src/main/res/mipmap-xxxhdpi/ic_launcher_round.png";
...
<button id="bds-toggle" type="button" onclick={toggleDrawer} aria-label="SHΞN Studio">
  <img class="bds-main-logo" src={studioLauncherIcon} alt="" aria-hidden="true" loading="eager" decoding="async" />
</button>
